...
const ATHLETE_TABS: Record<string, TabConfig> = {
  index: {
    name: 'index',
    label: 'Accueil',
    renderIcon: (color) => <Feather name="home" size={22} color={color} />,
  },
  calendar: {
    name: 'calendar',
    label: 'Séances',
...
export const AthleteTabBar: React.FC<BottomTabBarProps> = ({
  state,
  descriptors,
  navigation,
}) => {
